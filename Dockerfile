...
ENV VERTICLE_HOME=/opt/vertx/verticles
...
# Set UID and GID for the container
ARG UID=2604
ARG GID=2604
...
ENTRYPOINT ["/entrypoint.sh", "/opt/vertx/verticles/Vertx-Datastar-1.0.0-SNAPSHOT-fat.jar"]
